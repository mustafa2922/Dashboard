...
const Navbar = () => {
  return (
    <div className="flex justify-between flex-row items-center w-full bg-white px-1 h-[3rem]">
      <div className="flex items-center lg:w-[50%] w-[75%] h-full ">
        ...
        <div className="flex ml-8 border border-slate-300 active:border-slate-800 focus:border-slate-800 hover:border-slate-800 rounded-md">
          <select
            className="px-2 focus:outline-none w-[8rem] rounded-md">
          ...
          <div>
            <div className="relative">
              <input
                placeholder="Search "
                className=" border-l-slate-300 border-l text-sm h-full pl-2 pr-8  focus:outline-none "
              />
              <SearchIcon className="text-slate-600 absolute right-0.5 " />
            </div>
          </div>
        </div>
      </div>
